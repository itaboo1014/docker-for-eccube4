...
EC-CUBE4.3.1-p1:
	curl -vOL https://downloads.ec-cube.net/src/eccube-4.3.1-p1.tar.gz
	tar -zxvf eccube-4.3.1-p1.tar.gz
	mv ec-cube eccube
	rm eccube-4.3.1-p1.tar.gz
	@echo "\n\n\nEC-CUBE4.3.1-p1 Download Complete!!!\n\n\n"

EC-CUBE4.3.1-p1-latest:
	curl -vOL https://downloads.ec-cube.net/src/eccube-4.3.1-p1.tar.gz
	tar -zxvf eccube-4.3.1-p1.tar.gz
	mv ec-cube eccube
	rm eccube-4.3.1-p1.tar.gz
...
EC-CUBE4.3.1-p1-light:
	...
	make PHP8.3
	make SQLite3
	@echo "\n\n\nPHP8.3 SQLite3 Setup Complete!!!\n\n\n"

EC-CUBE4.3.1:
	curl -vOL https://downloads.ec-cube.net/src/eccube-4.3.1.tar.gz
	tar -zxvf eccube-4.3.1.tar.gz
	mv ec-cube eccube
	rm eccube-4.3.1.tar.gz
	@echo "\n\n\nEC-CUBE4.3.1 Download Complete!!!\n\n\n"
...
EC-CUBE4.3.0:
	curl -vOL https://downloads.ec-cube.net/src/eccube-4.3.0.tar.gz
	tar -zxvf eccube-4.3.0.tar.gz
	mv ec-cube eccube
	rm eccube-4.3.0.tar.gz
...
EC-CUBE4.2.3-p2:
	curl -vOL https://downloads.ec-cube.net/src/eccube-4.2.3-p2.tar.gz
	tar -zxvf eccube-4.2.3-p2.tar.gz
	mv ec-cube eccube
	rm eccube-4.2.3-p2.tar.gz
	@echo "\n\n\nEC-CUBE4.2.3-p2 Download Complete!!!\n\n\n"

EC-CUBE4.2.3-p2-latest:
	curl -vOL https://downloads.ec-cube.net/src/eccube-4.2.3-p2.tar.gz
	tar -zxvf eccube-4.2.3-p2.tar.gz
	mv ec-cube eccube
	rm eccube-4.2.3-p2.tar.gz
...
EC-CUBE4.2.3-p1:
	curl -vOL https://downloads.ec-cube.net/src/eccube-4.2.3-p1.tar.gz
	tar -zxvf eccube-4.2.3-p1.tar.gz
	mv ec-cube eccube
	rm eccube-4.2.3-p1.tar.gz
	@echo "\n\n\nEC-CUBE4.2.3-p1 Download Complete!!!\n\n\n"

EC-CUBE4.2.3-p1-latest:
	curl -vOL https://downloads.ec-cube.net/src/eccube-4.2.3-p1.tar.gz
	tar -zxvf eccube-4.2.3-p1.tar.gz
	mv ec-cube eccube
	rm eccube-4.2.3-p1.tar.gz
...
EC-CUBE4.2.2:
	...
	mv ec-cube eccube
	rm eccube-4.2.2.tar.gz
	@echo "\n\n\nEC-CUBE4.2.2 Download Complete!!!\n\n\n"
...
EC-CUBE4.1.2-p5:
	curl -vOL https://downloads.ec-cube.net/src/eccube-4.1.2-p5.tar.gz
	tar -zxvf eccube-4.1.2-p5.tar.gz
	mv ec-cube eccube
	rm eccube-4.1.2-p5.tar.gz
	@echo "\n\n\nEC-CUBE4.1.2-p5 Download Complete!!!\n\n\n"

EC-CUBE4.1.2-p5-latest:
	curl -vOL https://downloads.ec-cube.net/src/eccube-4.1.2-p5.tar.gz
	tar -zxvf eccube-4.1.2-p5.tar.gz
	mv ec-cube eccube
	rm eccube-4.1.2-p5.tar.gz
...
EC-CUBE4.1.2-p4:
	curl -vOL https://downloads.ec-cube.net/src/eccube-4.1.2-p4.tar.gz
	tar -zxvf eccube-4.1.2-p4.tar.gz
	mv ec-cube eccube
	rm eccube-4.1.2-p4.tar.gz
	@echo "\n\n\nEC-CUBE4.1.2-p4 Download Complete!!!\n\n\n"

EC-CUBE4.1.2-p4-latest:
	curl -vOL https://downloads.ec-cube.net/src/eccube-4.1.2-p4.tar.gz
	tar -zxvf eccube-4.1.2-p4.tar.gz
	mv ec-cube eccube
	rm eccube-4.1.2-p4.tar.gz
...
EC-CUBE4.0.6-p5:
	curl -vOL https://downloads.ec-cube.net/src/eccube-4.0.6-p5.tar.gz
	tar -zxvf eccube-4.0.6-p5.tar.gz
	mv eccube-4.0.6-p5 eccube
	rm eccube-4.0.6-p5.tar.gz
	@echo "\n\n\nEC-CUBE4.0.6-p5 Download Complete!!!\n\n\n"

EC-CUBE4.0.6-p5-latest:
	curl -vOL https://downloads.ec-cube.net/src/eccube-4.0.6-p5.tar.gz
	tar -zxvf eccube-4.0.6-p5.tar.gz
	mv eccube-4.0.6-p5 eccube
	rm eccube-4.0.6-p5.tar.gz
